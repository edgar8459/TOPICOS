...
namespace NaveEspacial
{
    ...
    internal class Enemigos
    {
        ...
        private DateTime _timeMovimiento;
        public List <Bala> Balas { get; set; }
        private DateTime _timepoDisparo;
        private float _tiempoDisparoAleatorio;
        public Nave NaveC { get; set; }
        public Enemigos(Point posicion, ConsoleColor color, Ventana ventana,
            TipoEnemigo tipoEnemigo, Nave nave)
        {
            ...
            _timeMovimiento = DateTime.Now;
            _timepoDisparo = DateTime.Now;
        ...
        public void Mover()
        {
            ...
            if(DateTime.Now > _timeMovimiento.AddMilliseconds(30))
            {
                Borrar();
                DireccionAleatoria();
        ...
        public void Colisiones(Point posicionAux)
        {
            ...
            if (posicionAux.Y +2 >= VentanaC.LimiteSuperior.Y + 15)
            {
                ...
                posicionAux.Y = VentanaC.LimiteSuperior.X + 15-2;
            }
        ...
        {
            if(DateTime.Now > _timepoDisparo.AddMilliseconds(_tiempoDisparoAleatorio))
            {
                Random random = new Random();
                if (TipoEnemigoE == TipoEnemigo.Normal)
                {
        ...
        {
            Console.ForegroundColor = Color;
            Console.SetCursorPosition(VentanaC.LimiteSuperior.X+distanciaX,
                VentanaC.LimiteSuperior.Y-1);
